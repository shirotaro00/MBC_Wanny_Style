                ...
                <div class="page-inner">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="card">
                                <div class="card-body">
                                    <p>Article vendue par jours</p>
                                    <i class="fa-solid fa-cart-shopping"></i> <span class="fw-bold">{{ $articlesVendusJour }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <div class="card-body">
                                    <p>Article vendue par semaine</p>
                                    <i class="fa-solid fa-cart-shopping"></i><span class="fw-bold">{{ $articlesVendusSemaine }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
