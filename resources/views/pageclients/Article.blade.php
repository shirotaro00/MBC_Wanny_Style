                                ...
                                <div class="accordion" id="accordionExample">
                                    <div class="card">
                                        <div class="card-heading active">
                                            <a data-toggle="collapse" data-target="#collapseOne">Homme</a>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-heading">
                                            <a data-toggle="collapse" data-target="#collapseTwo">Femme</a>
                                        </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    ...
                                    <div class="product__item__text">
                                        ...
                                        <div class="product__price">{{ number_format($article->prix, 0, ',', ' ') }} MGA
                                        </div>
                                    </div>
                                </div>
                            </div>
