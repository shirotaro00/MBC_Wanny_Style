        ...
        {{-- produit forech --}}
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mix women">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{ asset('assets/upload/' . $article->photo) }}">
                        <div class="label new">New</div>
                        <ul class="product__hover">
                            <li><a href=" {{ asset('assets/upload/' . $article->photo) }} " class="image-popup"><span class="arrow_expand"></span></a></li>
                    ...
                    <div class="product__item__text">
                        ...
                        <div class="product__price">{{ $article->prix }} MGA</div>
                    </div>
                </div>
            </div>
